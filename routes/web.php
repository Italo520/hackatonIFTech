...
|--------------------------------------------------------------------------
*/
Route::middleware(['auth', 'role:super_admin,prefeito,secretario,gestor_conteudo,gestor_cadastros'])->group(function () {
    ...
    // Módulos de Gestão - Alertas e Auditoria
    ...
    // Módulo de Gestão - Validação de Prestadores (Restrito a cadastros, secretaria e super_admin)
    Route::middleware('role:super_admin,gestor_cadastros,secretario,prefeito')->group(function () {
